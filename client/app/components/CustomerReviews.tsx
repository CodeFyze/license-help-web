...
const CustomerReviews: React.FC = () => {
  return (
    <div className="bg-[#F1F1F1] py-12 px-4 md:px-10 lg:px-20 shadow-[#00000080] shadow-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3 gap-10 lg:gap-5  xl:gap-10 2xl:gap-0  2xl:pl-28 px-10 ">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="bg-white rounded-xl w-72 shadow-md p-6 relative flex flex-col items-start"
          >
